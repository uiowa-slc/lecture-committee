<header class="header border-bottom">
                                ...
                                <li class="nav-item">
                                    <% if $URLSegment == "live" %>
                                        <% if $Top.StreamingLectureToday %>
                                            <a class="btn btn-blue" href="$Top.StreamingLectureToday.StreamingLink"><svg aria-hidden="true" aria-labelledby="title" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-broadcast" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
                                        ...
                                        <% else %>
                                            <a class="nav-link <% if $LinkOrSection == "section" %>active<% end_if %>" href="$Link"><svg aria-hidden="true" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-broadcast" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M3.05 3.05a7 7 0 0 0 0 9.9.5.5 0 0 1-.707.707 8 8 0 0 1 0-11.314.5.5 0 0 1 .707.707zm2.122 2.122a4 4 0 0 0 0 5.656.5.5 0 0 1-.708.708 5 5 0 0 1 0-7.072.5.5 0 0 1 .708.708zm5.656-.708a.5.5 0 0 1 .708 0 5 5 0 0 1 0 7.072.5.5 0 1 1-.708-.708 4 4 0 0 0 0-5.656.5.5 0 0 1 0-.708zm2.122-2.12a.5.5 0 0 1 .707 0 8 8 0 0 1 0 11.313.5.5 0 0 1-.707-.707 7 7 0 0 0 0-9.9.5.5 0 0 1 0-.707z"/>
                        <path d="M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
                        </svg> $MenuTitle</a>
                                        <% end_if %>
        ...
        <div class="row">
            <div class="col-12">
                <% if $StreamingLectureToday %>
                    <div class="">
                        <p class="event-alert text-center my-3"> <a class="" href="$StreamingLectureToday.StreamingLink"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-broadcast" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M3.05 3.05a7 7 0 0 0 0 9.9.5.5 0 0 1-.707.707 8 8 0 0 1 0-11.314.5.5 0 0 1 .707.707zm2.122 2.122a4 4 0 0 0 0 5.656.5.5 0 0 1-.708.708 5 5 0 0 1 0-7.072.5.5 0 0 1 .708.708zm5.656-.708a.5.5 0 0 1 .708 0 5 5 0 0 1 0 7.072.5.5 0 1 1-.708-.708 4 4 0 0 0 0-5.656.5.5 0 0 1 0-.708zm2.122-2.12a.5.5 0 0 1 .707 0 8 8 0 0 1 0 11.313.5.5 0 0 1-.707-.707 7 7 0 0 0 0-9.9.5.5 0 0 1 0-.707z"/>
                        <path d="M10 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/>
