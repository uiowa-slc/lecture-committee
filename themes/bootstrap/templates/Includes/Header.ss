                                ...
                                <li class="nav-item">
                                    <% if $URLSegment == "live" %>
                                        <% if $Top.StreamingLectureToday %>
                                            <a class="btn btn-blue" href="$Link"><svg aria-hidden="true" aria-labelledby="title" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-broadcast" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
