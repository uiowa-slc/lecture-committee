    ...
    <div class="container-xl">
        <div class="row d-flex align-items-center">
            <div class="col-sm-8 col-md-7">
                ...
                <div class="my-5">
                    <p class="h3 my-2"><i class="fab fa-facebook"></i> Find us on Facebook: <a href="$SiteConfig.FacebookLink" target="_blank" rel="noopener">@uilectures</a><br />
                    </p>
                    <p class="h3 my-2"><i class="fab fa-twitter"></i> Follow us on Twitter: <a href="$SiteConfig.TwitterLink" target="_blank" rel="noopener">@iowa.ulc</a></p>
                </div>
