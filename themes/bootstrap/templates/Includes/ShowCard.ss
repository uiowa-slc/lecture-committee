	...
	<div class="row no-gutters">
		...
		<div class="col-md-4 order-1 order-md-12">
			<a href="$Link" class="d-block pl-lg-3">
				<img data-ratio="1" class="lazyload d-block w-100 show-image show-image--small" src="$resourceURL('themes/bootstrap/dist/images/lecture-placeholder.png')" data-src="$Picture.Pad(400,400,fff).URL" class="card-img" alt="" role="presentation" loading="lazy">
			</a>
		</div>
		<% end_if %>
	</div>
